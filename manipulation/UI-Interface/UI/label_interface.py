...
class MainInterface(QMainWindow):
    ...
    def init_sidebar_functions(self):
        ...
        button = QPushButton("Load Model Noise")
        ...
        ## save selection
        button = QPushButton("Save Selection (Tail)")
        ...
        ## save selection
        button = QPushButton("Save Selection (Body)")
    ...
    def load_noise(self):
        ...
        fileName, _ = QFileDialog.getOpenFileName(self, "Open a Noise Vector", directory = load_noise_path, initialFilter= "npy file (*.npy)", options = options)
    ...
    def save_selection(self, index : int):
        ...
        np.save(self.debugger.file_path(os.path.join(current_folder, f'selection_{index}.npy')), selection)
