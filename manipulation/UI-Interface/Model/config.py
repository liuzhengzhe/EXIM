...
parser.add_argument('--max_epoch', type=int, default=600, help='number of epochs to train for')
parser.add_argument('--GPU', type=int, default=52, help='dimensional of noise')
parser.add_argument('--nz', type=int, default=128, help='dimensional of noise')
parser.add_argument('--nv', type=float, default=1.0, help='value of noise')
...
parser.add_argument('--bal_para', type=float, default=0.16, help='value of noise')
