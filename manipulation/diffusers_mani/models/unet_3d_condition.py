...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # input
        self.conv_in = nn.Conv3d(in_channels+2, block_out_channels[0], kernel_size=3, padding=(1, 1, 1))
    ...
    def forward(
        ...
        #print (inpaint_image, inpaint_mask, 'inpaint')
        sample=torch.cat([sample, inpaint_image * inpaint_mask, inpaint_mask], dim=1)
