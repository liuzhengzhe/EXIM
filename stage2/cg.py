...
color=torch.load('experiments/iVoxels_dist-0.5_0.5_sigmas-0.1_0.01_v128_mShapeNet128Vox/checkpoints/checkpoint_epoch_0.tar')
...
torch.save(color,'experiments/iVoxels_dist-0.5_0.5_sigmas-0.1_0.01_v128_mShapeNet128Vox/checkpoints/checkpoint_epoch_1000.tar')