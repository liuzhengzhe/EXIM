...
if __name__ == '__main__':
    ...
    scale_ratio = 0.9
    recompute = False
    obj_names_path = r'/research/dept6/khhui/sdf_samples_scaled_reconstruction/file_names_chairs.txt'
    data_folder = r'/research/dept6/khhui/proj51_backup/edward/ShapeNetCore.v1'
    save_folder = r'/research/dept6/khhui/sdf_samples_scaled_reconstruction'
